...
namespace Tp_WindowsForms
{
    interface Interface_GuardarCargas
    {
        ...
        List<Ventas> Ventas();
        List<Presupuestos> TodosLosPresupuestos();
        ConverPresupuestoEnVenta ConvertirPresupueso(Presupuestos parametro_presupuesto);
        Presupuestos BuscarPresupuesto(int parametro);
    }
}
