...
namespace Tp_WindowsForms
{
    ...
    {   
        ...
        {
            Form frm_NuevoProducto = new Form_CargaProductos(this.NuevaEmpresa.ObtenerNumeroSiguienteProducto(), this);
       ...
       {
            this.NuevaEmpresa.DeserializarCliente();
            this.NuevaEmpresa.DeserializarProducto();
            this.NuevaEmpresa.DeserializarPresupuestos();
            this.NuevaEmpresa.DeserializarVentas();      
            this.NuevaEmpresa.DeserializarDevolucionesCanceladas();
            this.NuevaEmpresa.DeserializarDevolucionesDefectuosas();
        }
        ...
        {
            Form NuevoPresupuesto = new Form_Presupuestos(this);
        ...
        {
            Form NuevoCLiente = new Form_CargaClientes(this.NuevaEmpresa.ObtenerNumeroSiguienteCliente(), this, this);
        ...
        {
            Form NuevoGrillaVenta = new Form_GrillaVenta(this);
        ...
        private void vERGRILLAPRESUPUESTOToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form NuevaGrillaPresupuesto = new Form_GrillaPresupuestos();
            NuevaGrillaPresupuesto.Owner = this.Owner;
            NuevaGrillaPresupuesto.Show(this);
        }

        public List<Presupuestos> TodosLosPresupuestos()
        {
           return this.NuevaEmpresa.ListaPresupuestosSinEliminados();
        }

        public ConverPresupuestoEnVenta ConvertirPresupueso(Presupuestos parametro_presupuesto)
        {
            return this.NuevaEmpresa.ConvertirPresupuestoEnVenta( parametro_presupuesto);
        }
        ...
        public Presupuestos BuscarPresupuesto(int parametro)
        {
            return this.NuevaEmpresa.PresupuestoBuscado(parametro);
        }

        private void Form_MenuPrincipal_FormClosing(object sender, FormClosingEventArgs e) //Cierra aplicacion
        {
