namespace Tp_WindowsForms
{
    partial class Form_Reporte2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.comboBox_Nombre, "Seleccione nombre de producto");
            ...
            this.toolTip1.SetToolTip(this.button_Confirmar, "Confirma el nombre de producto seleccionado");
