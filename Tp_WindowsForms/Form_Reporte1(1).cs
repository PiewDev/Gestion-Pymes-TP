    ...
    public partial class Form_Reporte1 : Form
    {
        ...
        private void button_Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (Form_MenuPrincipal!=null)
            {
                ...
                dataGridView1.DataSource =Form_MenuPrincipal.Reporte1(DateTime.Parse(dateTimePicker_FechaDeste.Text), DateTime.Parse(dateTimePicker_FechaHasta.Text) ,ClienteSeleccionado.ClienteSelect.Nombre,ClienteSeleccionado.ClienteSelect.Apellido);
            }
        }
    }
}
